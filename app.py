...
# -----------------------------
def genie_allowed():
    if os.getenv('GENIE_BETA_ENABLED', 'false').lower() not in ['1', 'true', 'yes']:
        return False
    en = BetaEnrollment.query.filter_by(status='APPROVED').first()
